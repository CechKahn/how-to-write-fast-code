...
/*
	Choose optimization option for calculating euclidian distance
				   ...
				   int    *membership)        /* out: [numObjs] */
{
	...
	unsigned *local_delta; //use array of unsigned int to replace the delta 
	int int_delta;
	unsigned int_threshold = threshold * numObjs; //convert the threshold into integer number for later comparison
